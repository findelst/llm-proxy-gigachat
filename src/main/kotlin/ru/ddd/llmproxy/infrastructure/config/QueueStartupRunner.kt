 ...
 *
 * This ensures that the PriorityQueue begins consuming requests
 * as soon as the Spring context is fully initialized.
 */
@Component
class QueueStartupRunner(
    private val priorityQueue: PriorityQueue<ChatRequest, ChatResponse>,
